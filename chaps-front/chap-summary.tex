...
\hline%------------------------------------------------------------
 Design and build a small-scale greenhouse capable of measuring and controlling all the necessary elements to sustain amicable living conditions for various plants while enabling the user with wireless monitoring capabilities. The greenhouse must be powered by entirely solar energy. \\[1ex]
