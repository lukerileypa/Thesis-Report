...
The Full Greenhouse setup constructed on the engineering roof can be seen in the figure below. Please see Appendix \ref{chap:pics} for additional pictures.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{figs/soiltest.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{figs/lighttest2.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{figs/CO2test.jpg}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.68\textwidth}
		...
		\label{fig:temp_on}
	\end{subfigure}
	\caption{Internal vs. external temperature with (a) Actuators off and (b) Actuators on.}
...
\subsubsection*{Soil Moisture Control}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figs/lux.png}
	\caption{Lux Profile}
	\label{fig:Lux}
\end{figure}
...
\begin{ThreePartTable}
	...
	\begin{longtable}{|p{1.5cm}|p{4.4cm}|c|p{3cm}|p{3cm}|}
		...
		13 & Operational Power Duration                           & 24\,h      & Not Tested            & Remained sufficiently charged via solar over cloudy periods \\ \hline
...
The operational success of the greenhouse was evaluated in a controlled two-week microgreen growth trial designed to verify the system’s capacity to maintain suitable environmental conditions. Microgreens were chosen for their fast growth cycle and nutrient-dense, high-value characteristics, making them a sensitive and informative indicator of environmental control. The experiment functioned as a performance test against the design requirements for temperature, humidity, irrigation, and lighting regulation. Four varieties (peas, radish, beetroot, and arugula) were cultivated inside the greenhouse. As shown in the before-and-after photographs below, all varieties exhibited healthy germination and vigorous growth, confirming that the system effectively supported sustained plant development and met its intended functional objectives.
