...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.79\textwidth]{figs/anotated.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.6\textwidth]{figs/airflow1.png}}
	\caption{Air Intake}
...
\begin{table}[h]
	\centering
	\caption{Soil Moisture Sensor Specifications}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.48\textwidth]{figs/LCD.jpg}
