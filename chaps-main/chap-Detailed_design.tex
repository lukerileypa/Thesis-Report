...
A battery capacity of at least 70Ah is required to power the average energy usage of the system and its components as shown in the calculations in Appendix \ref{chap:calcs} . Thus to provide for DoD depth of discharge allowance minimum discharge of 20\% for safe lithium battery usage a battery capacity of 100Ah is selected. 
