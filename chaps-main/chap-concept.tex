...
\hline
7 & Light sensing\tnote{2} & 0--600 & 0--600 & \si{\micro\mole\per\metre\squared\per\second} & SR2 \\
\hline
8 & Latency in displaying environmental conditions & Minimize & <120 & s & SR3 \\
\hline
9 & Control temperature\tnote{4} & User selected\tnote{3} & 15--30 & °C & SR4 \\
\hline
10 & Control soil moisture content\tnote{5} & User selected & 50--100 & \% & SR5 \\
\hline
11 & Control humidity\tnote{6} & User selected & 40--90 & \% & SR5 \\
\hline
...
\hline
14 & Battery storage capacity & 24\tnote{7} & >24 & hours & SR6 \\
\hline
\end{tabular}
\begin{tablenotes}
\footnotesize
\item[1] \citep{weatherStellenbosch2024} Maximum average wind speeds peak at 18.8 kph in Stellenbosch during January.
\item[2] \citep{definitiveGrowLight2024}. Ideal ranges for Seedlings: 100–300, Vegetative: 300–600 \si{\micro\mole\per\metre\squared\per\second}
\item[3] The System should allow desired ranges to be setable by the user, however suitable testing thresholds are used as follows.
...
\item[6] \citep{Wei2024}. Tolerable humidity is between 40–90\% for greenhouses.
\item[7] The system must maintain power throughout the night.
