...
\begin{table}[H]
	...
	\begin{threeparttable}
		...
		\begin{tabular}{|p{1.5cm}|p{4.5cm}|c|c|c|p{2.5cm}|}
			...
			\hline
			1 & Resist Wind speeds\tnote{1} & 18.81 & >18.8 & kph & SR1 \\
			\hline
			2 & Temperature sensing range\tnote{2} & Maximize & -10--50 & °C & SR2 \\
			\hline
			3 & Soil moisture sensing & 0--100 & 0--100 & \% & SR2 \\
			\hline
			4 & Humidity sensing & 0--100 & 0--100 & RH\% & SR2 \\
			\hline
			5 & CO\textsubscript{2} sensing range \tnote{3} & 0--1000 & 0--1000 & ppm & SR2 \\
			\hline
			6 & Light sensing\tnote{4} & 0--600 & 0--600 & \si{\micro\mole\per\metre\squared\per\second} & SR2 \\
			\hline
			7 & Latency in displaying environmental conditions & Minimize & <120 & s & SR3 \\
			\hline
			8 & Control temperature\tnote{6} & User selected\tnote{5} & 15--30 & °C & SR4 \\
			\hline
			9 & Control soil moisture content\tnote{7} & User selected & 50--100 & \% & SR5 \\
			\hline
			10 & Control humidity\tnote{8} & User selected & 40--90 & \% & SR5 \\
			\hline
			11 & Supplemental lighting intensity\tnote{4} & 200 & 100--300 & \si{\micro\mole\per\metre\squared\per\second} & SR4 \\
			\hline
			12 & Energy Consumption & Minimize & 0--1200 & Wh & SR8 \\
			\hline
			13 & Battery storage capacity\tnote{9} & 24 & >24 & hours & SR6 \\
			\hline
		\end{tabular}
		\begin{tablenotes}
			\footnotesize
			...
			\item[9] The system must maintain power throughout the night.
