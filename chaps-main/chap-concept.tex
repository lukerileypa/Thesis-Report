...
\hline
3 & Temperature sensing range\tnote{2} & Maximize & -10--50 & °C & SR2 \\
\hline
4 & Soil moisture sensing & 0--100 & 0--100 & \% & SR2 \\
\hline
5 & Humidity sensing & 0--100 & 0--100 & RH\% & SR2 \\
\hline
6 & CO\textsubscript{2} sensing range \tnote{3} & 0--1000 & 0--1000 & ppm & SR2 \\
\hline
7 & Light sensing\tnote{4} & 0--600 & 0--600 & \si{\micro\mole\per\metre\squared\per\second} & SR2 \\
\hline
8 & Latency in displaying environmental conditions & Minimize & <120 & s & SR3 \\
\hline
9 & Control temperature\tnote{6} & User selected\tnote{5} & 15--30 & °C & SR4 \\
\hline
10 & Control soil moisture content\tnote{7} & User selected & 50--100 & \% & SR5 \\
\hline
11 & Control humidity\tnote{8} & User selected & 40--90 & \% & SR5 \\
\hline
12 & Supplemental lighting intensity\tnote{4} & 200 & 100--300 & \si{\micro\mole\per\metre\squared\per\second} & SR4 \\
\hline
13 & Energy Consumption & Minimize & 0--1200 & Wh & SR8 \\
\hline
14 & Battery storage capacity\tnote{9} & 24 & >24 & hours & SR6 \\
\hline
\end{tabular}
\begin{tablenotes}
\footnotesize
...
The primary subsystems and their corresponding functions are numbered from 1.0 to 7.0. These serve as the foundation for the physical decomposition discussed after the concept evaluation.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{figs/phys1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{figs/phys2.png}}
