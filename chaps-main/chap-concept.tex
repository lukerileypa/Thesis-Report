...
\begin{ThreePartTable}
	\begin{TableNotes}
		...
		\item[9] Practical target limit enables affordable 24-hour operation with standard 12V 100Ah battery (1200 Wh usable capacity).
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figs/Funct.png}}
