...
The control logic is structured into distinct modules, arranged in approximate order of priority: \textit{Principal Control}, \textit{Temperature Control}, \textit{Airflow Control}, \textit{Irrigation Control}, \textit{Lighting Control}, and \textit{Air Quality Control}.
