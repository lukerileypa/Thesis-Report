...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=0.55\textwidth]{figs/Co2.jpg}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{figs/shapes.jpg}}
...
The inclination angle significantly affects solar heat gain by altering the amount of radiation absorbed by the greenhouse surface. \citep{Mellalou2022}. As shown in figure \ref{fig:inclin} below, solar energy gaining rates decrease with steeper angles, particularly for the N--S orientation. While both orientations perform similarly at \SI{15}{\degree}, the E--W orientation consistently captures more energy at higher inclinations. This highlights the importance of optimizing both orientation and tilt to balance heat gain and internal climate control.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{figs/sawtooth.jpg}}
